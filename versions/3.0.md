...
<a name="securitySchemeSignatureMethod"></a>signatureMethod | [`string`] | `oauth1` | A list of supported signatures used for authorization. Valid values are `"HMAC-SHA1"`, `"RSA-SHA1"`, or `"PLAINTEXT"`. Default vaule is `"HMAC-SHA1"`
<a name="securityAuthorizationMethod"></a>authorizationMethod | [`string`] | `oauth1` | A list of supported mothods used for authorization. Valid values are `"header"`, `"post"`, or `"get"`. Default vaule is `"header"`
